...
module.exports = function (config) {
    return function () {
        ...
        rootDoc.produce = ['application/json'];
        ...
        app.providers.push(function (path, service) {
            ...
            // console.log(service.Model.attributes);
            if(typeof service.Model.attributes.password !== 'undefined'){
                console.log(service.Model.attributes.password.type);
                console.log(service.Model.attributes.password.type.constructor.prototype.key);
            }
            ...
            if(typeof rootDoc.definitions[path] === 'undefined'){
