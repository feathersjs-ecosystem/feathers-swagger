...
function addDefinitionToSchemas(schemas, definition, model) {
...
class OpenApiV3Generator extends AbstractApiGenerator {
  ...
  applyDefinitionsToSpecs (service, model) {
    if (typeof service.docs.definition !== 'undefined') {
      addDefinitionToSchemas(this.specs.components.schemas, service.docs.definition, model);
    }
    if (typeof service.docs.schema !== 'undefined') {
      addDefinitionToSchemas(this.specs.components.schemas, service.docs.schema, model);
    }
